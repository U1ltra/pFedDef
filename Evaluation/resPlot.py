...
def plotBars(
    ...
    for i in range(len(tableau_colors)):
        ...
        tableau_colors[i] = (r / 255.0, g / 255.0, b / 255.0)
...
def plotCurve(xaxis, yaxis, xticks, title, x_label, y_label, legend_label, save_path):
    fig, ax = plt.subplots(figsize=(14, 6))
    for idx, line in enumerate(yaxis):
        ax.plot(
            xaxis[idx],
            line,
