...
if __name__ == "__main__":
    ...
    client_weights = [70, 60, 50, 40, 30, 20, 10, 5]
    exp_names = [f'rep_test_client_w_lr_{int(i*100)}' for i in lr_set]
    ...
    for client_weight in client_weights:
        ...
        for itt in range(len(exp_names)):
            ...
            args_.seed = 1234
            args_.verbose = 1
            args_.logs_root = f'/home/ubuntu/Documents/jiarui/experiments/lr_and_w/weight{client_weight}/{exp_names[itt]}/logs'
            args_.save_path = f'/home/ubuntu/Documents/jiarui/experiments/lr_and_w/weight{client_weight}/{exp_names[itt]}/weights'      # weight save path
            ...
            for i in range(atk_count):
                ...
                aggregator.clients[i].turn_malicious(
                    factor = client_weight / lr_set[itt],  
                    attack = "replacement",
