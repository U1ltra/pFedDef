...
class fakeNewsDataset(Dataset):
    def __init__(self, data = "train_embeddings.npy", target = "train_labels.npy"):
...
def main():
    ...
    dataset = fakeNewsDataset(data = "raw_data/train_embeddings.npy", target = "raw_data/train_labels.npy")
